...
- `当前市值 / 2026E 或 2027E 利润` 得到 Forward PE。
- 用 2026-2028 或 2025-2027 CAGR 做增速。
...
| 情景 | 利润锚 | CAGR 区间 | 复合增速 | 复合 PEG | 对应 PE | 目标市值 | 触发条件 |
| --- | ---: | --- | ---: | ---: | ---: | ---: | --- |
| 中性 |  |  |  |  |  |  |  |
| 乐观 |  |  |  |  |  |  |  |
...
- CAGR 通常用 2026E-2028E 或 2025A-2027E。
- 复合 PEG 应和动态 PEG 互相校验：若差异很大，说明单年增速可能失真。
- 最终目标市值优先取动态 PEG 和复合 PEG 收敛区间。
