...
1. **DCF-ready package from Financial Modeling** - When `<company>_dcf_ready_package.md` or equivalent structured inputs are provided, treat them as the primary operating forecast and UFCF bridge.
2. **MCP Servers** (if configured) - Structured financial data from providers like Daloopa
